...
class FlightsProject:
    def __init__(self):
       pass
    ''' This method randomly samples 10% of "1987.csv file. The size of the population is too high for my system memory. Dropped NaN columns and unified the data types across all "year" dataset'''
    ...
    ''' This method randomly samples 10% of "1989.csv file. The size of the population is too high for my system memory. Dropped NaN columns and unified the data types across all "year" dataset'''
    ...
    ''' This method randomly samples 10% of "1990.csv file. The size of the population is too high for my system memory. Dropped NaN columns and unified the data types across all "year" dataset'''
    ...
    ''' This method randomly samples 10% of "1991.csv file. The size of the population is too high for my system memory. Dropped NaN columns and unified the data types across all "year" dataset'''
    ...
    ''' This method randomly samples 10% of "1992.csv file. The size of the population is too high for my system memory. Dropped NaN columns and unified the data types across all "year" dataset''' 
    ...
    ''' This method randomly samples 10% of "1993.csv file. The size of the population is too high for my system memory. Dropped NaN columns and unified the data types across all "year" dataset'''
    ...
    ''' This method randomly samples 10% of "1994.csv file. The size of the population is too high for my system memory. Dropped NaN columns and unified the data types across all "year" dataset'''
    ...
    ''' This method randomly samples 10% of "1995.csv file. The size of the population is too high for my system memory. Dropped NaN columns and unified the data types across all "year" dataset'''
    ...
    ''' This method randomly samples 10% of "1996.csv file. The size of the population is too high for my system memory. Dropped NaN columns and unified the data types across all "year" dataset'''
